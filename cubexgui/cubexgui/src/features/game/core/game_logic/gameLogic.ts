...
export const getAiMoveWithContext = (state: GameState, difficulty: Difficulty): { fromId: string, to: Position } | null => {
    console.log(`🔌 [GAME LOGIC] Handing off to AI Kernel...`);
    return getAIMove(state, difficulty, AI_BRAIN, syncDifficultyProfile);
};
