                ...
                <div className="space-y-4 mb-6">
                    <div>
                        ...
                        <div className="flex gap-2">
                            <button onClick={() => setMode('HvH')} className={clsx("flex-1 py-2 text-xs border rounded transition-colors", mode === 'HvH' ? "bg-cyan-900/50 border-cyan-500 text-cyan-400" : "border-cyber-700 text-slate-500 hover:border-slate-500")}>
                                Human vs Human
                            </button>
                             <button onClick={() => setMode('HvAI')} className={clsx("flex-1 py-2 text-xs border rounded transition-colors", mode === 'HvAI' ? "bg-pink-900/50 border-pink-500 text-pink-400" : "border-cyber-700 text-slate-500 hover:border-slate-500")}>
                                Human vs AI
                            </button>
                        </div>
                    </div>
