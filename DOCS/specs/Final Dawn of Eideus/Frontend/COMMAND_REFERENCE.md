...
**Available Affinities:** `str`, `int`, `dex`

**Core Classes:**
| Class | STR | INT | DEX | Description |
|-------|-----|-----|-----|-------------|
| **Rebel** | +1 | -1 | 0 | Disgruntled citizen looking to make changes |
| **Acolyte** | 0 | +1 | -1 | Augment seeking induction into the Church of the Ascension |
| **Hacker** | -1 | 0 | +1 | Systems specialist who gets off on the fact no doors hold secrets long |
